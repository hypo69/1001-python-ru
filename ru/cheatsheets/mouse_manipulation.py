...
# ======================================================================
# Шаг 8: Функция записи и воспроизведения событий
# ======================================================================

def record_and_play_events():
    """
    Записывает события мыши до нажатия правой кнопки и затем воспроизводит их.
    """
    print(">> [Шаг 8: Запись] Начало записи. Нажмите и отпустите правую кнопку, чтобы остановить.")
    print(">> Вы можете подвигаться, пощелкать или прокрутить колесо мыши.")
    ...
    print(">> [Шаг 8: Воспроизведение] Воспроизводим записанные события...")
    mouse.play(events[:-1])
...
if __name__ == "__main__":
    ...
    print("--- Запуск учебного кода 'mouse_manipulation.py' (Библиотека: mouse) ---")
    ...
    # --- Шаг 8: Запись и воспроизведение событий (раскомментируйте вызов) ---
    print("\n--- Шаг 8: Запись и воспроизведение ---")
    # record_and_play_events() # <-- Раскомментируйте, чтобы запустить интерактивную запись
    print("Шаг 8: Вызов функции record_and_play_events() закомментирован. Раскомментируйте, чтобы проверить.")
    time.sleep(1)
