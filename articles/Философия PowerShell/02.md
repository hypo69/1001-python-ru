...
### 1. Вызов методов прямо в конвейер

В конвейере можно вызывать методы объектов напрямую
...
Зная о свойстве `StartTime`, мы можем легко найти все процессы, запущенные за последний час:
