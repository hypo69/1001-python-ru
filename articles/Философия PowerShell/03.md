...
##### **Анализ дискового пространства (одна строка)**
...
Часть 3: [Конвейер (Pipeline), переменные, Get-Member, файл .ps1 и экспорт результатов.](https://github.com/hypo69/1001-python-ru/blob/master/articles/%D0%A4%D0%B8%D0%BB%D0%BE%D1%81%D0%BE%D1%84%D0%B8%D1%8F%20PowerShell/02.md)
