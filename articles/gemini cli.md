...
Узнайте, как установить Gemini CLI на ваш локальный компьютер, как начать проект с нуля или работать с существующим, и многое другое.


**Gemini CLI** — это ИИ-помощник с открытым исходным кодом от Google, который встраивает Gemini непосредственно в ваш рабочий процесс разработки. Вы можете использовать Gemini 1.5 Pro и его контекстное окно в 1 миллион токенов для выполнения до 60 запросов в минуту и 1000 запросов в день, и все это бесплатно.
...
*   **Генерация тестов:** Автоматически создает тестовые случаи для `pytest`, чтобы повысить надежность и уверенность в CI.
...
*   **Обоснование на поиске (Search grounding):** Инструмент `@search` может использоваться для получения информации в реальном времени для проверки лучших практик.
