...
Однажды я просто хотел скачать Excel-файл с сайта Росстата, а в ответ получил страшную портянку с ошибкой `SSLCertVerificationError`. Если вы тоже её встретили — не паникуйте. В этой статье я покажу, что это за зверь, как его укротить и почему он вообще появляется. А ещё мы немного поговорим про SSL-сертификаты, инструменты диагностики вроде **OpenSSL**, системные хранилища и даже создадим свой сертификат с нуля. Поехали!
